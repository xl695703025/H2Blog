                        ...
                        <div class="menu_section">
                            ...
                            <ul class="nav side-menu">
                                ...
                                <li><a><i class="fa fa-tag"></i>标签管理 <span class="fa fa-chevron-down"></span></a>
                                    <ul class="nav child_menu">
                                        <li><a href="../tag/add" class="tagAddMenu">添加标签</a></li>
            ...
            <div class="right_col" role="main" id="indexContent" >
                ...
                <div class="row tile_count">
                    <div class="col-md-2 col-sm-4 col-xs-6 tile_stats_count">
                        <span class="count_top"><i class="fa fa-book"></i> 总共的博文</span>
                        <div class="count" id="articleCount">${articleCount }</div>
                        <!-- <span class="count_bottom"> 超越<i class="green">100% </i>的用户</span> -->
                    </div>
                    <div class="col-md-2 col-sm-4 col-xs-6 tile_stats_count">
                        <span class="count_top"><i class="fa fa-eye"></i> 总访问量</span>
                        <div class="count" id="viewCount">${viewCount }</div>
                        <!-- <span class="count_bottom"> 超越<i class="green">100% </i>的用户</span> -->
                    </div>
                    <div class="col-md-2 col-sm-4 col-xs-6 tile_stats_count">
                        <span class="count_top"><i class="fa fa-thumbs-o-up"></i> 点赞</span>
                        <div class="count" id="likeCount">${likeCount }</div>
                        <!-- <span class="count_bottom"> 超越<i class="green">100% </i>的用户</span> -->
                    </div>
                    <div class="col-md-2 col-sm-4 col-xs-6 tile_stats_count">
                        <span class="count_top"><i class="fa fa-comment"></i> 总留言数</span>
                        <div class="count" id="commentCount">${commentCount }</div>
                        <!-- <span class="count_bottom"> 超越<i class="green">100% </i>的用户</span> -->
                    </div>
                </div>
                ...
                <div class="table-responsive">
	            	...
	            	<p style="float: right"><span style="font-size: 25px">当前页数:[<span id="now">${page.pageNow }</span>/<span id="total">${page.totalPageCount }</span>]&nbsp;</span>
	            		<c:if test="${page.pageNow>1 }"><a class="btn btn-default submit" href="index?pageNow=${page.pageNow-1 }&pageSize=${page.pageSize }" >上一页</a></c:if>
	                    <c:if test="${page.pageNow<page.totalPageCount }"><a class="btn btn-default submit" href="index?pageNow=${page.pageNow+1 }&pageSize=${page.pageSize }" >下一页</a></c:if>
	                </p>
                </div>
            </div>
            <!-- 修改博客 -->
