...
<body class="nav-md footer_fixed">
                        ...
                        <tbody id="tbody5">
                        	<c:forEach items="${commentList }" var="comment">
	                            <tr class="even pointer">
	                                <td class=" ">${comment.commentId }</td>
	                                <td class=" ">${comment.commentAuthorName }</td>
	                                <td class=" ">${comment.article.articleTitle }</td>
	                                <td class=" ">${comment.commentAuthorEmail }</td>
	                                <td class=" ">${comment.commentContent }</td>
	                                <td class=" ">${comment.commentIp }</td>
	                                <td class=" "><fmt:formatDate value="${ comment.commentCreateTime}" pattern="yyyy-MM-dd HH:mm:ss" /></td>
	                                <td class=" last"><a class="delBtn" href="javascript:;">删除</a></td>
	                            </tr>
                            </c:forEach>
                        </tbody>
                </table>
    ...
    <script src="../statics/js/commentManage.js"></script>
</body>
