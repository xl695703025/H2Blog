...
<body class="nav-md footer_fixed">
                            ...
                            <tbody id="tbody4">
		                        <c:forEach items="${tagList }" var="tag">
	                               <tr class="even pointer" id="hideRow3">
	                                   ...
	                                   <td class=" ">${tag.tagDescription }</td>
	                                   <td class=" last"><a class="delBtn" href="javascript:;">删除</a>|<a class="update" href="javascript:;">修改</a></td>
	                               </tr>
		                        </c:forEach>
                            </tbody>
                    </table>
    ...
    <script src="../statics/js/tagManage.js"></script>
</body>
